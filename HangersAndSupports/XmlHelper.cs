   ...
   public class XmlHelper
    {
        ...
        /// </summary>
        /// <paramname="xpath">要匹配的XPath表达式(例如:"//节点名//子节点名")</param>
        /// <paramname="node">要匹配的XmlNode</param>
        /// <returns>返回XmlNodeList</returns>
        public XmlNodeList GetXmlNodeListByXmlNode(string xpath,XmlNode node)
        {
            try
            {
        ...
        /// <paramname="xmlAttributeName">要匹配xmlAttributeName的属性名称</param>
        /// <returns>返回xmlAttributeName</returns>
        public XmlAttribute GetXmlAttributeByXmlNode( string xpath, XmlNode node, string xmlAttributeName)
        {
            string content = string.Empty;
            XmlAttribute xmlAttribute = null;
            try
